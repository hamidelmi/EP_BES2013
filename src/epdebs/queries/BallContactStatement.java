...
public class BallContactStatement {
	...
	public BallContactStatement(EPAdministrator admin, UpdateListener listener) {
		String query = "insert into BallContactEvent  "
				+ "select BallEventA.ts as ts, BallEventA.sid as ballId, BallEventA.timeInGame as "
				+ "timeInGame,  BallEventA.x as x, BallEventA.y as y, BallEventA.z as z, BallEventA.vx as vx, "
				...
				+ "epdebs.parser.Match.IsGoal(BallEventA.ts, BallEventA.x, BallEventA.y,BallEventA.z, BallEventA.abs_v, "
