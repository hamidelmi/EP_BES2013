...
public class HeatMapDeltaPositionStatement
{
	...
	{
		String stmt = "insert into DeltaHPEvent "
					+ "select "
					+ "(b.ts - a.ts) / 1000000000 as dts, "
					+ "b.ts as currts, "
					...
					+ "from pattern  [ every a=HeatPositionEvent -> b=HeatPositionEvent(playerName=a.playerName, resolution=a.resolution)]";
